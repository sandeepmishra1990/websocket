...
import com.org.DTO.ChatMessage;
...
public class Chatendpoint {
	...
	@OnOpen
	public void open(Session session,@PathParam(value = "address") String address)
	{
		queue.add(session);
	...
	public void onMessage(Session session,String msg) throws IOException
	{
		...
		//String currentaddress = session.getb
		for(Session ses: queue)
		{
			...
			{
				//if(ses.getUserProperties().get("address").equals(add)){
				try {
